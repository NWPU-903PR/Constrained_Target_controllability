function [ CNV_name,CNV_data,SNP_name,SNP_data,EXPR_name,EXPR_data ] = sample_information( expression_fileName, CNV_fileName,SNP_fileName)
%Function:main function of our PSCS
%Input:
